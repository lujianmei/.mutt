...
## Mutt check attachments before send if there is a keyword that mentioned attachment
...
KEYWORDS='attach|anhang|anhaenge|anhänge|angehaengt|angehangen|anbei|angehängt|附件'
